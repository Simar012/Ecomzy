...
export const loadUser = () => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get('https://ecomzy-backend-nfkl.onrender.com/api/v1/me');
...
export const logoutUser = () => async (dispatch) => {
    try {
        await axios.get('https://ecomzy-backend-nfkl.onrender.com/api/v1/logout');
...
export const updateProfile = (userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(
            'https://ecomzy-backend-nfkl.onrender.com/api/v1/me/update',
            userData,
            config
        );
...
export const updatePassword = (passwords) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(
            'https://ecomzy-backend-nfkl.onrender.com/api/v1/password/update',
            passwords,
            config
        );
...
export const forgotPassword = (email) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(
            'https://ecomzy-backend-nfkl.onrender.com/api/v1/password/forgot',
            email,
            config
        );
...
export const resetPassword = (token, passwords) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(
            `https://ecomzy-backend-nfkl.onrender.com/api/v1/password/reset/${token}`,
            passwords,
            config
        );
